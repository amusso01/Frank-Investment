      ...
      <div class="front-single-post">
            ...
            <figure>
              <img
                ...
                class="lazyload" />
                <p class="caption">SUBSCRIBE TO OUR COMPLIMENTARY MARKET COMMENTARY</p>
            </figure>

            <a  href="<?= get_the_title( $post[0]->ID )?>" class="card-content">
                <p class="article-info"><?=  get_the_date( 'F d, Y', $post[0]->ID ) ?> by <?= the_author_meta( 'display_name' , $post[0]->post_author ); ?></p>
